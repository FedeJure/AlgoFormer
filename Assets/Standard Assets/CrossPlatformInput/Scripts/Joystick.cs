...
public class Joystick : MonoBehaviour , IPointerUpHandler , IPointerDownHandler , IDragHandler {
	...
	public int MovementRangeX = 100;
	public int MovementRangeY = 100;
	...
	private void UpdateVirtualAxes (Vector3 value) {
		...
		delta.y = -delta.y;
		delta.x /= MovementRangeX;
		delta.y /= MovementRangeY;
		if (useX) {
	...
	public  void OnDrag(PointerEventData data) {
		...
		transform.position = Vector3.ClampMagnitude( new Vector3(newPos.x , newPos.y , newPos.z), MovementRangeX) + startPos;
